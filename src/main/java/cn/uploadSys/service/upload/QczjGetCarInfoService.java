...
public class QczjGetCarInfoService{
    ...
    public List<QczjCarInfoVO> getCarBrands(String appId, String queryKey) {
        ...
        try {
            ...
            String importUrl = String.format(url, accessToken, appId, queryKey);
            json = Unirest.get(importUrl).asJson();
            ...
            log.info("获取车品牌异常,异常原因:{},异常报文:{}",e.getStackTrace(),json.toString());
        }
        return null;
    }
    ...
    public List<QczjCarInfoVO> getCarProducts(String appId, String queryKey,String seriesId) {
        ...
        try {
            ...
            log.info("获取车型牌异常,异常原因:{},异常报文:{}",e.getStackTrace(),json.toString());
        }
        return null;
    }
