                        ...
                        <div class="ibox-content">
                            <div class="bar search-bar">
                                <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <label>课程名</label>
                                        <input type="text" class="form-control" id="classesName" style="width: 150px;">
                                    </div>
                                    &nbsp&nbsp&nbsp
                                    <div class="form-group">
                                        <label>状态</label>
                                        <select class="form-control" id="status">
                                            <option class="option_1" value="0" >未消课</option>
                                    ...
                                    <button class="btn btn-success"  id="search" type="button" onclick="StudentsDetail.search()">搜索</button>&nbsp
                                    <button class="btn btn-success" type="button" onclick="StudentsDetail.resetSearch()">重置</button>&nbsp
<#--                                    <button class="btn btn-primary" type="button" onclick="SignUp.create()">新增</button>-->
...
<script src="/static/modular/students/studentsDetail.js"></script>
